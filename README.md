...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noba1anc3/yolov3-tf2/blob/master/docs/colab_gpu.ipynb)
...
[Project Design Documentation](https://github.com/Noba1anc3/yolov3-tf2/wiki/Design-Documentary)
...
```bash
# Tensorflow CPU
conda env create -f docs/conda-cpu.yml
conda activate yolov3-tf2-cpu

# Tensorflow GPU
conda env create -f docs/conda-gpu.yml
...
##### Beihang-Pan Url
[Darknet Pre-trained Weights](https://bhpan.buaa.edu.cn:443/link/3D63AB5519CD21232B4E33A6D58B7DEE)
...
See the documentation here https://github.com/noba1anc3/yolov3-tf2/blob/master/docs/training_voc.md
